...
from helper_functions import read_newest_results, flatten_data, transform_coordinates, rescale_and_shift_image, calculate_error, append_to_ndjson
...
# saves the results            
def ask_questions(category : str):
    pass
